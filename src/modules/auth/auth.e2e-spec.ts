...
describe("Auth", () => {
    ...
    it("+ Login", async () => {
         ...
         */
        const hashedPassword = await hasha.async(password, {
            algorithm: "sha1",
        })
    ...
    it("- Login (IncorrectUsernameOrPassword)", async () => {
        ...
        try {
            ...
            expect(errData).toEqual(AuthErrors.IncorrectUsernameOrPassword)
        }
    })
    ...
    it("- Me API UnSuccessfuly (UserIsNotAuthorized)", async () => {
        ...
        try {
            ...
            const errData = err.response.data
            expect(errData).toEqual(AuthErrors.UserIsNotAuthorized)
        }
    })
    ...
    it("+ CreateUser API Successfuly", async () => {
        ...
        const prismaData = await prisma.users.findFirst({
            where: {
                username: username.toLowerCase(),
            },
        })
        ...
        expect(prismaData.password).toBe(hashedPassword)
    ...
    it("- CreateUser API UnSuccessfuly (AccessDenied)", async () => {
        ...
        try {
            ...
            const errData = err.response.data
            expect(errData).toEqual(AuthErrors.AccessDenied)
        }
    })
    ...
    it("- CreateUser API UnSuccessfuly (UsernameIsDuplicated)", async () => {
        ...
        try {
            ...
            const errData = err.response.data
            expect(errData).toEqual(AuthErrors.UsernameIsDuplicated)
        }
    })
    ...
    it("+ ReadUsers API Successfuly (Where)", async () => {
        ...
        const userPassword01 = await hasha.async(userPass01, {
            algorithm: "sha1",
        })
        ...
        const userPassword02 = await hasha.async(userPass02, {
            algorithm: "sha1",
        })
        ...
        const userPassword03 = await hasha.async(userPass03, {
            algorithm: "sha1",
        })
    ...
    it("- UpdateUser API UnSuccessfuly (UserNotFound)", async () => {
        ...
        try {
            ...
            const errData = err.response.data
            expect(errData).toEqual(AuthErrors.UserNotFound)
        }
    })
    ...
    it("- UpdateUser API UnSuccessfuly (UsernameIsDuplicated)", async () => {
        ...
        const userPassword01 = await hasha.async("user01", {
            algorithm: "sha1",
        })
        const user01 = await prisma.users.create({
            data: {
        ...
        const userPassword02 = await hasha.async("user02", {
            algorithm: "sha1",
        })
        await prisma.users.create({
            data: {
    ...
    it("+ ChangePassword API Successfuly", async () => {
        ...
        const hashedNewPassword = await hasha.async(newPassword, {
            algorithm: "sha1",
        })
        ...
        expect(findUser.password).toBe(hashedNewPassword)
    })
